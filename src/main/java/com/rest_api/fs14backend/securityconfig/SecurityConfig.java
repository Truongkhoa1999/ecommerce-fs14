...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/users","/signup", "/signin", "api/v1/products/","api/v1/products/id/{id}", "api/v1/products/search","api/v1/categories/","/api/v1/statics/", "/api/v1/statics/clicks/{id}","api/v1/products/add")
                .permitAll()
